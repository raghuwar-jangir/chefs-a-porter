...
const UpcomingSupperClubCard = () => {
  ...
  console.log('clubs', data.supper_club.upcoming_supper_club.supper_clubs);
  return (
    <React.Fragment>
                  ...
                  <Box className="super-chef-details">
                    ...
                    <span className="chef-tag">
                      ...
                      <Typography className="tag-detail">
                        {moment(item.dates[0]).format('MMMM D')} | {moment(item.timefrom, 'HH:mm').format('h:mm A')} - {moment(item.timetill, 'HH:mm').format('h:mm A')}
                      </Typography>
                    </span>
                    <span className="chef-tag">
