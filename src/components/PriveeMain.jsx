        ...
        {!_.isEmpty(data?.home) && (
          <>
            <Box className="continue-browsing-box">
              <Typography className="main-heading">{data.home.continue_browsing.title}</Typography>
              <Typography className="heading-details">{data.home.continue_browsing.description}</Typography>
              <Swiper
                style={{
                      ...
                      <Box className="name-box">
                        ...
                        <Box className="chef-details">
                          {item.details.tags.map((tagsItem, index) => {
                            return (
                              <span>
                                {tagsItem} {index !== item.details.tags.length - 1 && <span className="line">|</span>}
                              </span>
                            );
                          })}
                        </Box>
