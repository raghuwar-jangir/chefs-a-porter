          ...
          <Box className="about-box">
            ...
            <Box className="what-details">
              <Box className="sub-box-card">
                ...
                <Typography className="field-ans-2">
                  {userData?.user?.details?.fun_fact}
                </Typography>
              </Box>
              <Box className="sub-box-card">
                ...
                <Typography className="field-ans-2">
                  {userData?.user?.details?.worked_at}
                </Typography>
              </Box>
              <Box className="sub-box-card">
                <img className="logo" src={culinary} />
                <Typography className="field-name-2">
                  Culinary School:
                </Typography>
                <Typography className="field-ans-2">
                  {userData?.user?.details?.culinary_school}
                </Typography>
              </Box>
              <Box className="sub-box-card">
                ...
                <Typography className="field-ans-2">
                  {userData?.user?.details?.trained_under}
                </Typography>
              </Box>
            </Box>
            <Typography className="details-2">
              ...
              {!_.isEmpty(userData?.user?.details?.intro) && (
                <>
                  {isReadMore2 ? (
                    `${userData?.user?.details?.intro.slice(0, 100)}...`
                  ) : (
                    <span
                      dangerouslySetInnerHTML={{
                        __html: userData?.user?.details?.intro,
                      }}
                      style={{ whiteSpace: 'pre-line' }}
                    ></span>
                  )}
                  <span
                    ...
                    className="read-more-less--more-2"
                    role="presentation"
                    style={{ textDecoration: 'underline' }}
                  >
