    ...
    <React.Fragment>
      <BoxWrapper>
        <Box className="sub-div">
          <Typography className="heading">{props.treatTitle}</Typography>
          <Typography className="main-title">{props.mainTitle}</Typography>
          <Typography className="details">{props.detail}</Typography>
