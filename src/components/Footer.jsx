...
import { Box, styled, TextField, Typography, List, ListItemIcon, Grid, Link } from '@mui/material';
        ...
        <BoxWrapper className="box-heading">
          <Box className="social-heading">
            ...
            <Box className="social-icon">
              <a href={footerData.footer.footer.facebook_link} target='_blank'><InstagramIcon className="icon" /></a>
              ...
              <Grid item xs={2} sm={2}>
                <Box>
                  ...
                  <List>
                    ...
                    <Link href="/become-a-patron" className="listItem-subheading">
                      Became a Patron
                    </Link>
                  </List>
                  <List>
                    ...
                    <Link className="listItem-subheading" href="/corporate-booking">
                      Corporate Bookings
                    </Link>
                  </List>
                  <List>
                    ...
                    <Link href="/gift-cards" className="listItem-subheading">
                      Gift Cards
                    </Link>
                  </List>
                </Box>
              ...
              <Grid item xs={2} sm={2}>
                <Box>
                  ...
                  <List>
                    ...
                    <Link href="/private" className="listItem-subheading">
                      Private
                    </Link>
                  </List>
                  <List>
                    ...
                    <Link href="/ticketed" className="listItem-subheading">
                      Ticketed
                    </Link>
                  </List>
                </Box>
              ...
              <Grid item xs={2} sm={2}>
                <Box>
                  ...
                  <List>
                    ...
                    <Link href="/about-us" className="listItem-subheading">
                      About us
                    </Link>
                  </List>
                  <List>
                    ...
                    <Link href="" className="listItem-subheading">
                      Blogs
                    </Link>
                  </List>
                </Box>
              ...
              <Grid item xs={2} sm={2}>
                <Box>
                  ...
                  <List>
                    ...
                    <Link href="/join-chef" className="listItem-subheading">
                      As Chef
                    </Link>
                  </List>
                  <List>
              ...
              <Grid item xs={4} sm={4} style={{ display: 'flex', justifyContent: 'end' }}>
                <Box className="input-group">
                  ...
                  <List>
                    ...
                    <Link href="/contact-us" className="listItem-subheading">
                      Contact Us
                    </Link>
                  </List>
                  <List>
                    ...
                    <Link href="mailto:rsvp@chefsaporter.com" className="listItem-subheading">
                  ...
                  <List>
                    ...
                    <Link href="https://chat.whatsapp.com/DOEPvVVFkaQLKDScEeTYOq" target="_blank" className="listItem-subheading">
                      Join our Community
                    </Link>
                  </List>
                </Box>
