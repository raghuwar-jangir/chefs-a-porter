...
const ChefMakoCarousel = (props) => {
    ...
    const labels = userData?.chef?.details?.sliders?.map((item) => {
        return item.text
    })

    const image = userData?.chef?.details?.sliders?.map((item) => {
        return item.image
    })

    let labels1 = ['Conscious Dining', 'Championing Chefs', 'Community'];
    return (
        <React.Fragment>
            <MainContentBox>
                {
                    userData?.chef?.details?.sliders ? (
                        <div>
                        ...
                        <div>
                            ...
                            <Swiper
                                ...
                                pagination={{
                                    clickable: true,
                                    renderBullet: function (index, className) {
                                        return '<div class="' + className + '">' + (labels1[index]) +
                                            '</div>';
