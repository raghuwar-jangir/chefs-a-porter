...
const NeedHelp = (props) => {
  ...
  const { successOpen, setSuccessOpen, scheduleCallOpen, setScheduleCallOpen } =
          ...
          <React.Fragment>
            <Box md={6} sm={6} xs={12} xl={7}>
              <Typography className="main-heading">
                {title
                  ? title
                  : data?.home?.footer?.common_footer?.details?.title
                  ? data?.home?.footer?.common_footer?.details?.title
                  : "Need Help?"}
              </Typography>
              <Typography className="details">
                {description
                  ? description
                  : data?.home?.footer?.common_footer?.details?.description
                  ? data?.home?.footer?.common_footer?.details?.description
                  : "We respond within 24 business hours."}
              </Typography>
            </Box>
            <Box md={6} sm={6} xs={12} xl={7}>
              <Button type="submit" className="btn-1" onClick={handleOpen}>
                {button_call
                  ? button_call
              ...
              <Button type="submit" className="btn-2">
                <a href="mailto:rsvp@chefsaporter.com" className="email-link">
                  {button_email
                    ? button_email
