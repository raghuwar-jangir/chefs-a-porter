                            ...
                            <Box className="sub-box-2">
                                ...
                                <Box>
                                    <Box className='choose-seat'>
                                        ...
                                        <KeyboardArrowDownIcon className="seat-down"/>
                                    </Box>
                                    ...
                                    <Box className='regular-seat'>
                                        <div className="r-seat">
                                            ...
                                            <span className="r-seat-rate"><b className='r-seat-money'>₹ 4,500</b>/ diner</span>
                                        </div>
                                        <div>
                                            <div className="input-div">
                                                <RemoveIcon
                                ...
                                <Box>
                                    <div className="no-seat">
                                        <span className="sorry-text">We’re sorry! Seats aren’t available for that slot.<br/>
                                        Pick another slot or <span className="get-touch">Get in Touch</span></span>
                                    </div>
                                </Box>
