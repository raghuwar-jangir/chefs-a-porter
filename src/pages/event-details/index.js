            ...
            <Box className="row supper-chef-details">
              <Box className="details">
                ...
                <Box className="chef-details">
                  <Typography>by</Typography><Typography className="detail-1">Chef Mako Ravindran</Typography><span className="line">|</span><Typography className="detail-2">Starting from ₹5000 per diner</Typography> 
                  </Box>
              </Box>
            </Box>
