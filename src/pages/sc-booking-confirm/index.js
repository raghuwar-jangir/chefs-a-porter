...
import { styled, Box, Grid, Typography, Select, MenuItem,Stack,Modal,TextField,Link,Checkbox,TextareaAutosize } from "@mui/material";
 ...
 <MainBox>
                ...
                <div className="row supper-chef-details">
                    <div className="book-trad">
                        <ArrowBackIcon onClick={handleBookingSuccessOpen} className="arrow-left" />
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-lg-12">
                                                        <div className="share-link-copy">
                                                            <span>Share link for the Experience with your guests</span>
                                                        </div>
                                                    </div>
                                                    <hr className="hr"/>
                                                    <div className="col-lg-12">
                                                        <div className="form-check">
                                                            <label className="form-check-label" for="flexCheckDefault">GST Details</label>
