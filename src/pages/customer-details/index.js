...
const CustomerDetails = (props) => {
  ...
  const { setOtpNumber, setVerifyOtp, setResendOtp, setIsSendOtpApiCall } =
              ...
              <Box className="row customer-details addons-div">
                <Formik
                  initialValues={{
                    ...
                    // address: customerInfo?.address ? customerInfo?.address : formAddress,
                    address: formAddress,
                      ...
                      <Grid container>
                        ...
                        >
                            ...
                            <Grid xs={12} className="mb-3">
                              ...
                              <Box className="form-group country">
                                ...
                                <Typography className="alternative">
                                  Or Choose from Alternate{" "}
                                  <span onClick={handleOpen}>Venues</span>
                                </Typography>
                              </Box>
                            </Grid>
                            <Grid xs={12} className="mb-3">
                          ...
                          <Box className="row add-details">
                            <Typography className="ad-detail">
                              Additional Details{" "}
                            </Typography>
                            <Typography className="ex-detail mb-40">
                              Details help us customize your experience to make
                              it memorable
                            </Typography>
                            <Typography className="exp-title">
                              Experience
                            </Typography>
                            <Typography className="sp-occ ex-detail">
                            ...
                            >
                              ...
                              <TabPanel value={0} sx={{ p: 2 }}>
                                <Grid xs={12} className="mb-3">
                                  ...
                                  />
                                  <Typography className="sp-occ ex-detail">
                                    We will send you exclusive offers on this
                                    day
                                  </Typography>
                                </Grid>
                              </TabPanel>
                              <TabPanel value={1} sx={{ p: 2 }}>
                                <Grid xs={12} className="mb-3">
                                  ...
                                  <DatePickerInput
                                    ...
                                    placeholder="-DD/MM/YYYY-"
                                    onChange={(dateString) =>
                                      setFieldValue("date1", dateString)
                                    }
                              ...
                              <TabPanel value={2} sx={{ p: 2 }}>
                                <Grid xs={12} className="mb-3">
                                  ...
                                  <DatePickerInput
                                    ...
                                    placeholder="-DD/MM/YYYY-"
                                    onChange={(dateString) =>
                                      setFieldValue("date2", dateString)
                                    }
                              ...
                              <TabPanel value={3} sx={{ p: 2 }}>
                                <Grid xs={12} className="mb-3">
                                  ...
                                  <DatePickerInput
                                    ...
                                    placeholder="-DD/MM/YYYY-"
                                    onChange={(dateString) =>
                                      setFieldValue("date3", dateString)
                                    }
                          ...
                          <Box className="row patron-check">
                            <Box className="col-lg-12 save-patron">
                              ...
                              />
                              <Box sx={{ width: "100%" }}>
                                <Typography className="save-title">
                                  Save 15% on all experiences by becoming a
                                  patron
                                </Typography>
                                <Typography className="save-subtitle">
                                  You will save <b>₹1300</b> on this booking
                                </Typography>
                              </Box>
                            </Box>
                          </Box>
                          ...
                          <Box className="per-dinner adsss">
                                  ...
                                  <Box className="table-box">
                                    ...
                                    <Typography className="table-details">
                                      {new Intl.NumberFormat("en-IN", {
                                        ...
                                        customerDetailsPaymentCalculation?.experience
                                      )}
                                    </Typography>
                                  </Box>
                                  <Box className="table-box">
                                    ...
                                    <Typography className="table-details">
                                      {new Intl.NumberFormat("en-IN", {
                                        ...
                                        customerDetailsPaymentCalculation?.service_staff
                                      )}
                                    </Typography>
                                  </Box>
                                  <Box className="table-box border table-details-pt">
                                    ...
                                    <Typography className="table-details">
                                      {new Intl.NumberFormat("en-IN", {
                                        ...
                                        customerDetailsPaymentCalculation?.sub_total
                                      )}
                                    </Typography>
                                  </Box>
                                  <Box className="table-box table-details-pt">
                                    ...
                                    <Typography className="table-details">
                                      {new Intl.NumberFormat("en-IN", {
                                        ...
                                        customerDetailsPaymentCalculation?.GST
                                      )}
                                    </Typography>
                                  </Box>
                                  <Box className="table-box">
                                    ...
                                    <Typography className="table-details">
                                      {new Intl.NumberFormat("en-IN", {
                                        ...
                                        customerDetailsPaymentCalculation?.service_charges
                                      )}
                                    </Typography>
                                  </Box>
                                  <Box className="table-box border">
                                    ...
                                    <Typography className="grand-total">
                                      {new Intl.NumberFormat("en-IN", {
                                        ...
                                        customerDetailsPaymentCalculation?.total
                                      )}
                                    </Typography>
                                  </Box>
                            ...
                            <Box className="row viewbreak">
                              ...
                              <Typography className="contact-text">
                                Our team will contact you regarding your protein
                                and allergeen Information after booking is
                                confirmed
                              </Typography>
                            </Box>
                          </Box>
