...
const GiftCards = () => {
  ...
  const validationSchema = Yup.object({
    ...
    contactNumber: Yup.number()
      .typeError("Incorrect Contact Number")
        ...
        {!_.isEmpty(data?.gift_card) && (
          <>
            ...
            <Box className="joinaschef">
              <Box
                className="corporate-b"
                sx={{
                  backgroundImage: `linear-gradient(180.32deg, rgba(0, 0, 0, 0) 21.51%, rgba(0, 0, 0, 0.4) 81.02%),url(${data.gift_card.header.image})`,
                }}
              >
                <Box className="container">
                  ...
                  <Box className="position-absolute patron-flex">
                    <Box>
                      <Typography className="become-heading">
                        {data.gift_card.header.title}
                      </Typography>
                      <Typography className="become-detail">
                        {data.gift_card.header.description}
                      </Typography>
                    </Box>
                    <Box>
                      <Typography style={{ width: "100%" }}>
                        <a href="#recipientDetails" className="apply">
                          {data.gift_card.header.button_text}
                        </a>
                      </Typography>
                    </Box>
                  </Box>
                    ...
                    <Form onSubmit={handleSubmit}>
                      <Box className="row white-bg justify-content-center">
                        <Box className="gift-work">
                          <Typography className="gift-work-heading">
                            {data.gift_card.working.title}
                          </Typography>
                          ...
                          <Box className="things-to-do">
                            <Typography className="things-to-do-details">
                              {data.gift_card.things_to_note.title}
                            </Typography>
                            <ul className="things-to-do-details things-to-do-ul">
                              {data.gift_card.things_to_note.content.map(
                                (item) => {
                                  return <li>{item}</li>;
                                }
                              )}
                          ...
                          <Box className="enter-amount">
                            <Box className="justify-content-between">
                              ...
                              <Box className="qty-box">
                                <label className="sr-only enter-amount-label">
                                  Qty
                                </label>
                        ...
                        <Box className="occasion">
                          <Box className="occasion-container">
                            <h4 className="occasion-title">
                              {data.gift_card.occasion.title}
                            </h4>
                            <Tabs aria-label="Basic tabs" defaultValue={0}>
                              ...
                              {data.gift_card.occasion.content.map(
                                (item, index) => {
                                  return (
                                            ...
                                            <div className="row occasion-title">
                                              <div className="col-lg-12">
                                                ...
                                                >
                                                  <Box>
                                                    {" "}
                                                    <Typography className="occasion-subtitle">
                                                      {item.title}
                                                    </Typography>
                                                  </Box>
                                                  <Box>
                        ...
                        <Box className="recipient" id="recipientDetails">
                          <Typography className="recipient-title">
                            {data.gift_card.recipient.title}
                          </Typography>
                          <Typography className="recipient-details">
                            {data.gift_card.recipient.description}
                          </Typography>
                ...
                <Box className="container">
                  <Box className="row">
                    <Box className="save-booking-details">
                      <img
                        src={trendingUp}
                        className="save-booking-img"
                        alt=""
                      />
                      {data.gift_card.gift_footer.text}
                    </Box>
                  </Box>
                </Box>
              </Box>
                ...
                <Box className="modal-content">
                  <Box className="patron-submitted">
                      ...
                      <Grid item xs={12} md={12} className="occasion-cards">
                        ...
                        <Box className="row occasion-title">
                          <Box className="col-lg-12">
                            <Typography className="occasion-heading">
                              Happy Wedding
                            </Typography>
                            <Typography className="occasion-title-message">
                              Wishing you the best of a lifetime of memories|
                            </Typography>
                            <p className="char-count">
                              <span id="rchars1">₹</span>2,500
                            </p>
                          </Box>
                        </Box>
                      </Grid>
                      <Grid item xs={12} md={12} className="receiver-details">
                        <Typography className="receiver-title">
                          Gift card sent successfully
                          <br /> to <span className="rec_name">Sana</span>
                        </Typography>
                        <Typography className="r-details">
                    ...
                    <Box className="apply_div">
                      ...
                      <Typography className="need-help">
                        Need Help?{" "}
                        <Link href="/contact-us" className="need-help-link">
                          Contact Us
                        </Link>
                      </Typography>
                    </Box>
                ...
                <Box className="allow-access">
                  ...
                  <Box className="access-box">
                    ...
                    <Box className="access-btn">
                      <Link
                        href="/gift-cards"
                        className="deny-permission-button"
                      >
                        Deny
                      </Link>
                      <Link
