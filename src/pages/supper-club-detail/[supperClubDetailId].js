            ...
            <Box className="main-box">
              <Box className="sub-box">
                ...
                <Typography className="sub-box-text">
                  ...
                  <Typography className="sub-box-text-2">
                    {userData?.seats - userData?.booking_count} Slots Left!
                  </Typography>
                </Typography>
              </Box>
              <Grid
                  ...
                  <Box className="sub-box-2">
                    ...
                    <Box>
                      <Stack className="date-stack">
                        ...
                        <Typography className="date-description">
                          {" "}
                          {moment(userData?.timefrom, "HH:mm").format(
                            "h:mm A"
                          )}{" "}
                          -{" "}
                          {moment(userData?.timetill, "HH:mm").format("h:mm A")}
                        </Typography>
                        <span className="line">|</span>
                        <Typography className="date-description">
                          {userData?.venue}
