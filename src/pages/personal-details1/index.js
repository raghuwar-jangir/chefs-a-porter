                      ...
                      <Box className="form-field">
                        <Box className="who-join">
                          ...
                          <div className="guest-details">
                            ...
                            <div className="guest-mail">
                              mayankjain@gmail.com
                            </div>
                      ...
                      <Box className="experience-breakup">
                        ...
                        {!_.isEmpty(personalDetailsPaymentCalculation) && (
                          <Box className="table table-borderless">
                            {Object.keys(personalDetailsPaymentCalculation).map(
                              (key, index) => {
                                return (
                                  <>
                                    <Box
                                    ...
                                    >
                                      ...
                                      <Typography className="table-details">
                                        {personalDetailsPaymentCalculation[key]}
                                      </Typography>
                                    </Box>
                                  </>
                                );
                            ...
                            <div className="second-box">
                              <div className="recipient">
                                ...
                                <Box className="row">
                                  ...
                                  <button type="submit" className="modal-add"   onClick={() => {
                                                            handleSubmit(values);
