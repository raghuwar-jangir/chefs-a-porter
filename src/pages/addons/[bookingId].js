...
const Addons = (props) => {
  ...
  const { addOnsData, adPaymentData, setPriveePayment } =
                ...
                <Box className="row customer-details addons-div">
                  <Grid container>
                    <Grid
                      ...
                      className="partner"
                    >
                      <Typography className="addons-heading">
                        Our partners help you get set up with the perfect custom
                        experience
                      </Typography>
                      <AddonsCard />
                    </Grid>
                      ...
                      <Box className="per-dinner adsss">
                              ...
                              <Box className="table-box">
                                ...
                                <Typography className="table-details">
                                  {new Intl.NumberFormat("en-IN", {
                                    style: "currency",
                                    currency: "INR",
                                  }).format(adPaymentData?.payment?.experience)}
                                </Typography>
                              </Box>
                              <Box className="table-box">
                                <Typography className="table-details">
                                ...
                                <Typography className="table-details">
                                  {new Intl.NumberFormat("en-IN", {
                                    ...
                                    adPaymentData?.payment?.service_staff
                                  )}
                                </Typography>
                              </Box>
                              <Box className="table-box">
                                ...
                                <Typography className="table-details">
                                  {new Intl.NumberFormat("en-IN", {
                                    style: "currency",
                                    currency: "INR",
                                  }).format(adPaymentData?.payment?.addon_cost)}
                                </Typography>
                              </Box>
                              <Box className="table-box border table-details-pt">
                                ...
                                <Typography className="table-details">
                                  {new Intl.NumberFormat("en-IN", {
                                    style: "currency",
                                    currency: "INR",
                                  }).format(adPaymentData?.payment?.sub_total)}
                                </Typography>
                              </Box>
                              <Box className="table-box table-details-pt">
                                ...
                                <Typography className="table-details">
                                  {new Intl.NumberFormat("en-IN", {
                                    style: "currency",
                                    currency: "INR",
                                  }).format(adPaymentData?.payment?.GST)}
                                </Typography>
                              </Box>
                              <Box className="table-box">
                                <Typography className="table-details">
                                ...
                                <Typography className="table-details">
                                  {new Intl.NumberFormat("en-IN", {
                                    ...
                                    adPaymentData?.payment?.service_charges
                                  )}
                                </Typography>
                              </Box>
                              <Box className="table-box border">
                                ...
                                <Typography className="grand-total">
                                  {new Intl.NumberFormat("en-IN", {
                                    style: "currency",
                                    currency: "INR",
                                  }).format(adPaymentData?.payment?.total)}
                                </Typography>
                              </Box>
                              <Box className="tax tax1">
                                <Typography className="table-details">
                                  *Includes the menu, tableware, table set-up
                                  and white-glove service.
                                </Typography>
                                <Typography className="table-details">
                                  **Service staff is calculated based on number
                                  of diners.
                                </Typography>
                              </Box>
                            </Box>
                        ...
                        <Box className="row viewbreak">
                          ...
                          <Typography className="contact-text">
                            ...
                            allergeen Information after booking is confirmed
                          </Typography>
                        </Box>
                      </Box>
                    </Grid>
