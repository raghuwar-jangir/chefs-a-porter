...
const PersonalDetails1 = () => {
    const {setOtpNumber, setVerifyOtp, setResendOtp, setIsSendOtpApiCall, openOtp, setOpenOtp, superClubBookingDetails,
        setSuperClubBookingDetails, setEventData} = useContext(OtpContext);
    const {mealTypeData, setChefFormData, setIsChefData, personalDetailsPaymentCalculation, setPersonalDetailsPaymentCalculation} = useContext(UsersContext);
            ...
            <MainBox>
                ...
                <div>
                    <Formik
                        ...
                        onSubmit={(values) => {
                            setSuperClubBookingDetails(values);
                            setEventData(values);
                                        ...
                                        <Box className="per-dinner adsss">
                                                            ...
                                                            <Typography className="table-details">
                                                                {
                                                                    new Intl.NumberFormat('en-IN', {
                                                                        style: 'currency',
                                                                        currency: 'INR'
                                                                    }).format(personalDetailsPaymentCalculation?.ticket_price)
                                                                }
                                                            </Typography>
                                                        </Box>
                                                        <Box className="table-box border-tb ">
                                                            ...
                                                            <Typography className="table-details table-details-pt">
                                                                {new Intl.NumberFormat('en-IN', {
                                                                    style: 'currency',
                                                                    currency: 'INR'
                                                                }).format(personalDetailsPaymentCalculation?.sub_total)}
                                                            </Typography>
                                                        </Box>
                                                        <Box className="table-box">
                                                            <Typography className="table-details table-details-pt">
                                                            ...
                                                            <Typography className="table-details table-details-pt">
                                                                {new Intl.NumberFormat('en-IN', {
                                                                    style: 'currency',
                                                                    currency: 'INR'
                                                                }).format(personalDetailsPaymentCalculation?.GST)}
                                                            </Typography>
                                                        </Box>
                                                        <Box className="table-box">
                                                            <Typography className="table-details">
                                                            ...
                                                            <Typography className="table-details">
                                                                {
                                                                    new Intl.NumberFormat('en-IN', {
                                                                        style: 'currency',
                                                                        currency: 'INR'
                                                                    }).format(personalDetailsPaymentCalculation?.service_charges)
                                                                }
                                                            </Typography>
                                                        </Box>
                                                        <Box className="table-box border">
                                                            ...
                                                            <Typography className="grand-total">
                                                                {new Intl.NumberFormat('en-IN', {
                                                                    style: 'currency',
                                                                    currency: 'INR'
                                                                }).format(personalDetailsPaymentCalculation?.total)}
                                                            </Typography>
                                                        </Box>
                                                    </Box>
                                                )}
                                            ...
                                            <Box className="row viewbreak">
                                                <Box>
                                                    <button
                                                        type="submit"
                                                        className={!isValid ? 'submit-req-disabled' : 'submit-req'}                                              
                                                    >
                                                        Next
                                                    </button>
                                                </Box>
